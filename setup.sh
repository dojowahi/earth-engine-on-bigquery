...
#bq query --use_legacy_sql=false 'SELECT gee.get_ndvi_month(lon,lat,name,2020,7) as ndvi_jul FROM `earth-engine-343601.gee.land_coords` LIMIT 10'
...
bq query --use_legacy_sql=false 'SELECT gee.get_poly_ndvi_month(farm_aoi,name,2020,7) as ndvi_jul FROM `earth-engine-343601.gee.land_coords` LIMIT 10'
